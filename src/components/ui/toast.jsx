...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
  return <Primitive.Root ref={ref} className={cn(toastVariants({ variant }), className)} {...props} />;
});
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (
  <Primitive.Title ref={ref} className={cn("text-sm font-semibold", className)} {...props} />
));
ToastTitle.displayName = Primitive.Title.displayName;

const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (
  <Primitive.Description ref={ref} className={cn("text-sm opacity-90", className)} {...props} />
));
